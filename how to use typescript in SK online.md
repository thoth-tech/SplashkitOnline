# Using TypeScript in an Online IDE

To use TypeScript in an Online IDE, follow these configuration steps:

##  Add TypeScript Script References

Add the following script tags at the bottom of your HTML page:

```html
<script src="https://unpkg.com/typescript@latest/lib/typescript.js"></script>
<script src="https://rawgit.com/basarat/typescript-script/master/transpiler.js"></script>
```
The transpiler.js file should be created by yourself and this is the code:
```bash
(function () {
...
Use TypeScript code within <script type="text/typescript">...</script> tags as shown below:
```bash
...
```
That's all, now you can use typescript in the SK online IDE! 